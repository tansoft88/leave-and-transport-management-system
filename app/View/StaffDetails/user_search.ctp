<?php	echo $this->Form->create('StaffDetail',array('action' => 'user_search'));?>
	<fieldset>
...
<tr>		
	...
	<td><?php echo $this->Html->link('Approve', array('controller' => 'staff_details', 'action' => 'approve_leave', $leaveData[$i]['LeaveApplication']['ec_number'],$leaveData[$i]['LeaveApplication']['id'])); ?></td>
	<td><?php echo $this->Html->link('DisApprove', array('controller' => 'staff_details', 'action' => 'disapprove_leave', $leaveData[$i]['LeaveApplication']['ec_number'],$leaveData[$i]['LeaveApplication']['id'])); ?></td>
