<?php	echo $this->Form->create('StaffDetail',array('action' => 'enter_leave'));?>
	<fieldset>
...
<table border ="-10" %  cellpadding="2" cellspacing="2">
	<tr>
	   ...
	   <th width="18%" style="white-space:nowrap;"><?php echo __('Total Days'); ?></th>
...
<tr>		
	...
	<td><?php echo $this->Html->link('Approve', array('controller' => 'staff_details', 'action' => 'approve_leave', $leaveData[$i]['LeaveApplication']['ec_number'])); ?></td>
	<td><?php echo $this->Html->link('DisApprove', array('controller' => 'staff_details', 'action' => 'disapprove_leave', $leaveData[$i]['LeaveApplication']['ec_number'])); ?></td>
	...
	echo "<br />";
	echo $this->Form->create('StaffDetail',array('action' => 'update_staff_leave'));
			echo $this->Form->label('Days Applied');
			echo $this->Form->input('days_applied', array('label' =>'<font color="red">*</font>','size'=>40));
			echo "<br />";
