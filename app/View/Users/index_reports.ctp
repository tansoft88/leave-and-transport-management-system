...
<ul><h3>
<li><?php echo $this->Html->link(__('Departments'), array('controller'=>'Departments','action' => 'index'));  ?>
	<?php // echo $this->Html->link(__('Users'), array('controller'=>'Users','action' => 'index'));  ?>
		<?php // echo $this->Html->link(__('Entry Points'), array('controller'=>'EntryPoints','action' => 'index'));  ?>
		<?php // echo $this->Html->link(__('Facultys'), array('controller'=>'Faculties','action' => 'index'));?>
      </h3>
</ul>
</fieldset>
<?php }?>
<?php if($current_user['system_group_id']==3){ //Ordinary Staff?>
<fieldset>
		<legend><b><?php echo __('Reports'); ?></b></legend>
		<br />
